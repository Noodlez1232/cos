...
{
	//Instead of calling another function to handle a newline, I just copied it here, for increased speeds
...
{
	//Write higher nibble by refrencing the hex table (One hex character = one nibble)
